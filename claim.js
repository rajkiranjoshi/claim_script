var Claim = function () {
  ...
  function Claim (config) {
    ...
    function createActivity (activity_type, desc, date_str, start_time, end_time) {
//      var day_upper = day.toUpperCase();
      try {
        ...
        */
        ...
        var start_time_min = parseInt(start_time.slice(3,5));
        var end_time_min = parseInt(end_time.slice(3,5));
      ...
      return function () {
        that.makeClaim(activity_type, desc, date_str, start_time, end_time);
      };
    }
    ...
    for (var i = 0; i < activities.length; i++) {
      var a = activities[i];
      this.activities_list.push(createActivity(a.activity_type, a.desc, a.date_str, a.start_time, a.end_time));
    }
  ...
  Claim.prototype.makeClaim = function (activity_type, desc, date_str, start_time, end_time) {
      /*
